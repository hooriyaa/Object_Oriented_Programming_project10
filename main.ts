...
console.log(
  chalk.bold.magenta(
    "\t\tWelcome To My Cli Typescript Project - 'OBJECT ORIENTED PROGRAMMING'\t\t"
  )
);
console.log("\t", "-".repeat(80), "\t");
  ...
  do {
    ...
    if (ans.select === "Staff") {
      ...
      if (!student) {
        ...
        console.log(
          `hello I am ${chalk.bold.red.italic(name.name)}, Nice to meet you!!`
        );
        ...
        console.log(
          `Hello i am ${chalk.bold.red.italic(
            student.name
